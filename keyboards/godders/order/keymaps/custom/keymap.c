...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(
		...
		KC_LCTL, KC_LCTL, KC_NO,   KC_LGUI, RAISE,   KC_ENT, KC_MPLY,  KC_SPC,  LOWER,   KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT),
	[_LOWER] = LAYOUT(
		...
		KC_TRNS, KC_NO,   KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_TRNS),
	[_RAISE] = LAYOUT(
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
		KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,       LSFT(KC_NUBS),KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_NUHS,
		KC_TRNS, KC_BTN5, KC_NO,   KC_NO,   KC_NO,   KC_NO,            KC_NUBS, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TILD,
